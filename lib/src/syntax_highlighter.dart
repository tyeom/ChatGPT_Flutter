...
class SyntaxHighlighterStyle {
  ...
  static SyntaxHighlighterStyle lightThemeStyle() {
    return SyntaxHighlighterStyle(
      baseStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF000000)),
      numberStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF1565C0)),
      commentStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF9E9E9E)),
      keywordStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF9C27B0)),
      stringStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF43A047)),
      punctuationStyle:
          const TextStyle(fontSize: 15.0, color: Color(0xFF000000)),
      classStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF512DA8)),
      constantStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF795548)),
    );
  }

  static SyntaxHighlighterStyle darkThemeStyle() {
    return SyntaxHighlighterStyle(
      baseStyle: const TextStyle(fontSize: 15.0, color: Color(0xFFFFFFFF)),
      numberStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF1565C0)),
      commentStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF9E9E9E)),
      keywordStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF80CBC4)),
      stringStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF009688)),
      punctuationStyle:
          const TextStyle(fontSize: 15.0, color: Color(0xFFFFFFFF)),
      classStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF009688)),
      constantStyle: const TextStyle(fontSize: 15.0, color: Color(0xFF795548)),
    );
  }
